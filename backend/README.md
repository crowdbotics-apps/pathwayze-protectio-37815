...
## Project Structure
    ...
    ├── pathwayze_protectio_37815  # Django project configurations
...
1. Clone this repo and `cd pathwayze_protectio_37815`
...
2. Clone this repo and `cd pathwayze_protectio_37815`
