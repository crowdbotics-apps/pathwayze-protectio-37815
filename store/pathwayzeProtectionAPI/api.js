...
const pathwayzeProtectionAPI = axios.create({
  baseURL: "https://pathwayze-protectio-37815.botics.co",
  headers: { Accept: "application/json", "Content-Type": "application/json" }
})
function api_v1_login_create(payload) {
  return pathwayzeProtectionAPI.post(`/api/v1/login/`)
}
function api_v1_signup_create(payload) {
  return pathwayzeProtectionAPI.post(`/api/v1/signup/`, payload.data)
}
function modules_social_auth_apple_connect_create(payload) {
  return pathwayzeProtectionAPI.post(
...
function modules_social_auth_socialaccounts_list(payload) {
  return pathwayzeProtectionAPI.get(`/modules/social-auth/socialaccounts/`)
}
...
function rest_auth_login_create(payload) {
  return pathwayzeProtectionAPI.post(`/rest-auth/login/`, payload.data)
}
function rest_auth_logout_list(payload) {
  return pathwayzeProtectionAPI.get(`/rest-auth/logout/`)
}
function rest_auth_logout_create(payload) {
  return pathwayzeProtectionAPI.post(`/rest-auth/logout/`)
}
...
function rest_auth_password_reset_create(payload) {
  return pathwayzeProtectionAPI.post(`/rest-auth/password/reset/`, payload.data)
}
...
function rest_auth_registration_create(payload) {
  return pathwayzeProtectionAPI.post(`/rest-auth/registration/`, payload.data)
}
...
function rest_auth_user_read(payload) {
  return pathwayzeProtectionAPI.get(`/rest-auth/user/`)
}
function rest_auth_user_update(payload) {
  return pathwayzeProtectionAPI.put(`/rest-auth/user/`, payload.data)
}
function rest_auth_user_partial_update(payload) {
  return pathwayzeProtectionAPI.patch(`/rest-auth/user/`, payload.data)
}
